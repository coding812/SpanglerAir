...
export default function Navbar() {
  ...
  return (
    <div className="">
      <nav className="bg-custom-blue  mt-6 md:mt-8 fixed top-0 left-0 w-full z-50 transition-opacity duration-700" style={{opacity: opacity}}>
        <div className="mx-auto max-w-8xl px-4 md:px-20">
          <div className="flex h-12 md:h-14 items-center justify-between">
            <div className="flex items-center">
              <div className="shrink-0 ">
                <img className="h-24 w-auto lg:h-36 lg:mt-4" style={{ opacity: 1 }} src="snow_flame.png" alt="Your Company" />
              </div>
              <div className="hidden md:block">
                <div className="flex items-baseline space-x-4">
                  ...
                  <a href="About-Us" className={`rounded-md px-3 py-2 text-3xl font-serif font-bold ${pathname === "/Team" ? "bg-gray-900 text-white" : "text-white hover:bg-gray-700 hover:text-white"}`}>About Us</a>
                </div>
              </div>
            </div>
